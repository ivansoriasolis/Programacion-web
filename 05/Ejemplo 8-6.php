<?php 
    ...
    for ($j = 0; $j < $rows; ++$j)
    {
        ...
        $r0 = htmlspecialchars($rows[0]);
        $r1 = htmlspecialchars($rows[1]);
        $r2 = htmlspecialchars($rows[2]);
        $r3 = htmlspecialchars($rows[3]);
        $r4 = htmlspecialchars($rows[4]);
        ...
        <input type='submit' value='BORRAR REGISTRO'></from>
        _END;
    }
